...
import {
  ...
  faDisplay, faVideo, faComments, faClipboardQuestion, faListCheck, faAddressBook, faCode
        ...
        @for (service of services(); track service.id) {
          <a [routerLink]="['/services', service.id]" class="google-card p-6 block">
            <div class="flex items-start gap-4">
              ...
              >
                <fa-icon [icon]="service.icon" class="text-2xl" [style.color]="service.color"></fa-icon>
              </div>
